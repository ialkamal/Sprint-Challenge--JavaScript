...
*/
let populationTotal = zooAnimals.reduce((sum, el) => {
  return sum + el.population;
}, 0);
...
function callback(par1, par2) {
  return `Argument #1 is: ${par1} and Argument #2 is: ${par2}.`;
}
...
console.log(consume(5, 4, callback));
console.log("\n");
...
console.log("Callback: Step #2 & Step #3");
